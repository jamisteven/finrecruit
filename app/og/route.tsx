...
export async function GET() {
  try {
    const fraunces = await readFile(join(process.cwd(), 'public/fraunces.woff2'))
      ...
      >
        ...
        <div style={{ display: 'flex', gap: '80px', marginTop: 'auto' }}>
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            <span style={{ fontSize: 52, fontWeight: 700, color: '#1A1A1A', fontFamily: 'Fraunces' }}>
              2,300+
            </span>
            <span style={{ fontSize: 14, color: '#9A9490', letterSpacing: '0.08em', marginTop: 4 }}>
              LIVE ROLES
            </span>
          </div>
          <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'flex-end' }}>
            <span style={{ fontSize: 20, color: '#9A9490' }}>
