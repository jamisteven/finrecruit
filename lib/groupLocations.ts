...
const REGIONS: { name: string; patterns: RegExp[] }[] = [
  {
    ...
    patterns: [
      ...
      /columbus|charlotte|denver|atlanta|philadelphia|miami|dallas|austin/i,
      /nashville|portland|las vegas|minneapolis|detroit|baltimore|cleveland/i,
      /schaffhausen|bern|basel|zug|lausanne/i,
